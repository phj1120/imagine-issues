...
public class DefaultKeyword {
    ...
    public static List<String> when = List.of("Morning", "night", "day", "winter", "summer", "spring", "fall");
    public static List<String> where = List.of("Field", "house", "sofa", "sky", "mountain", "sea");
}
